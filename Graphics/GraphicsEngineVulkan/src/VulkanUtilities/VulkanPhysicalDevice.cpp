    ...
    m_VkDevice{vkDevice}
{
    ...
    if (Instance.IsExtensionEnabled(VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME))
    {
        ...
        const auto                  VkVersion = std::min(Instance.GetVkInstanceVersion(), m_Properties.apiVersion);
        ...
        // Some features requires SPIRV 1.4 or 1.5 which was added to the Vulkan 1.2 core.
